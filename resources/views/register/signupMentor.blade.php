                ...
                <div class="p-6 space-y-6">
                    <form class="space-y-4 md:space-y-6" action="{{ route('register.mentor') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div>
                            ...
                            <input type="text" name="title" id="title" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none" placeholder=" Guru Berpengalaman 4 Tahun Dalam Dunia Pendidikan Dan Seni ...." required="" value="{{ old('title') }}">
                        </div>
                        <div>
                        ...
                        <div>
                            <label for="teaching_type" class="block mb-2 text-sm font-medium text-gray-900">Teaching Type</label>
                            <select name="teaching_type" id="teaching_type" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" required="">
